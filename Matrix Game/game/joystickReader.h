...
class joystickReader {
 ...
 public:
  ...
  int x() { return xDelta_; }
  int y() { return yDelta_; }
  int button() { return pushbuttonValue_; }
  util::pair<int, int> axis() { return util::pair<int, int>({xDelta_, yDelta_}); }
  ...
  util::pair<int, int> readAxis() {
    ...
    xDelta_ = currentXValue;
    yDelta_ = currentYValue;
